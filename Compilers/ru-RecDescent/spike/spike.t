...
=== TEST 17: separator given back when failed half-in-way
--- grammar
...
5*6-(3+2)/(7*4)-1
--- trace
  trying expr...    [5*6-(3+2)/(7*4)...]
    trying term...
      trying factor...
        trying factor_production_1...
          trying /\d+/...
          >>MATCH<< /\d+/...
        >>MATCH<< factor_production_1...
      >>MATCH<< factor...
      trying /[*/]/...    [*6-(3+2)/(7*4)-...]
      >>MATCH<< /[*/]/...
      trying factor...    [6-(3+2)/(7*4)-1...]
        trying factor_production_1...
          trying /\d+/...
          >>MATCH<< /\d+/...
        >>MATCH<< factor_production_1...
    ...
    trying /[-+]/...
    >>MATCH<< /[-+]/...
    trying term...    [(3+2)/(7*4)-1\n]
      trying factor...
        trying factor_production_1...
          trying /\d+/...
          FAIL to match /\d+/...
        FAIL to match factor_production_1...
        trying factor_production_2...
          trying '('...
          >>MATCH<< '('...
          trying expr...    [3+2)/(7*4)-1\n]
            trying term...
              trying factor...
                trying factor_production_1...
                  trying /\d+/...
