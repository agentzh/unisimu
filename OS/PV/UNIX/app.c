...
app must be run first, or you will get the following error message on Solaris 8:

    ×ÜÏß´íÎó£­ºËÐÄÏÝÚå

And you must clean all the semaphores and shared memory units before run app:
