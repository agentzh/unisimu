...
EventConsole->add_events( [0,10,20], $S, ['0','1','0'] );

#line 19 "t/SR_latch.tsl"
EventConsole->add_events( [0,30], $R, ['0','1'] );
...
EventConsole->add_events( [0,80,84,88,92,96], $S, ['0','1','0','1','0','1'] );

#line 33 "t/SR_latch.tsl"
EventConsole->add_events( [0,35,39,43,47,51], $R, ['1','0','1','0','1','0'] );
